...
<p>
  <a class="btn" href="` + EmailPlaceholderAppURL + "/pc_admin/#/auth/confirm-verification/" + EmailPlaceholderToken + `" target="_blank" rel="noopener">Verify</a>
</p>
<p>
  Thanks,<br/>
...
<p>
  <a class="btn" href="` + EmailPlaceholderAppURL + "/pc_admin/#/auth/confirm-password-reset/" + EmailPlaceholderToken + `" target="_blank" rel="noopener">Reset password</a>
</p>
...
<p>
  <a class="btn" href="` + EmailPlaceholderAppURL + "/pc_admin/#/auth/confirm-email-change/" + EmailPlaceholderToken + `" target="_blank" rel="noopener">Confirm new email</a>
</p>
